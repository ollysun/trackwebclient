...
class BillingAdapter extends BaseAdapter
{
     ...
     * @param null $billingPlanId
     * @param bool|false $send_all
     * @param null $offset
     * @param null $count
     * @return array|mixed|string
     */
    public function fetchAllBilling($billingPlanId = null, $send_all = false, $offset = null, $count = null)
    {
        $filters = array_filter(['billing_plan_id' => $billingPlanId, 'send_all' => $send_all, 'offset' => $offset, 'count' => $count]);
