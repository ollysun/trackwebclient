...
class RouteAdapter extends BaseAdapter
{
    ...
    public function getRoutes($branch_id=null, $offset = null, $count = null, $with_total=null, $send_all = null,$search=null){
        $filter = array('branch_id'=>$branch_id, 'offset'=>$offset, 'count'=>$count, 'send_all'=>$send_all, 'with_total_count'=>$with_total,'search' => $search);
