    ...
    public static function getMenus()
    {
        $menus = [
            ...
            'Shipments' => ['base' => 'shipments', 'class' => 'fa fa-car', 'base_link' => [
                'New_Shipments' => ['base_link' => 'shipments/processed',
                    'class' => '',
                    'branch' => [ServiceConstant::BRANCH_TYPE_EC,
                                 ServiceConstant::BRANCH_TYPE_HUB,
                                ServiceConstant::BRANCH_TYPE_HQ,
                                ServiceConstant::BRANCH_TYPE_COMPANY]],
                'Exported_Shipments' => ['base_link' => 'exportedparcel/allparcel',
                    'class' => '',
                    'branch' => [ServiceConstant::BRANCH_TYPE_EC,
                                ServiceConstant::BRANCH_TYPE_HUB,
                                ServiceConstant::BRANCH_TYPE_HQ]],
                ...
                'Ready_for_Sorting' => ['base_link' => 'hubs/destination', 'class' => '', 'branch' => [
                    ServiceConstant::BRANCH_TYPE_HUB, ServiceConstant::BRANCH_TYPE_HQ]],
                ...
                'Bulk_Shipment_Tasks' => ['base_link' => 'shipments/bulk', 'class' => '', 'branch' => [ServiceConstant::BRANCH_TYPE_HUB, 
				ServiceConstant::BRANCH_TYPE_EC, ServiceConstant::BRANCH_TYPE_HQ, ServiceConstant::BRANCH_TYPE_COMPANY]],
                ...
                'Validate_Parcels' => ['base' => 'validate', 'base_link' => 'shipments/validateparcels',
                    'class' => '',
                    'branch' => [ServiceConstant::BRANCH_TYPE_HQ]],
                'Report' => ['base' => 'report', 'base_link' => 'shipments/report',
                    'class' => 'fa fa-book', 'branch' => [ServiceConstant::BRANCH_TYPE_HQ, ServiceConstant::BRANCH_TYPE_HUB,
                    ServiceConstant::BRANCH_TYPE_COMPANY, ServiceConstant::USER_TYPE_OFFICER, ServiceConstant::USER_TYPE_COMPANY_ADMIN]]
            ], 'corporate' => true],
            ...
            'Administrator' => ['base' => 'admin', 'class' => 'fa fa-user',
                'base_link' => [
                    ...
                    'Manage_routes' => ['base_link' => 'admin/manageroutes', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    'Manage_staff_accounts' => ['base_link' => 'admin/managestaff', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    'Business_Territories' => ['base_link' => 'admin/busineszones', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    ...
                    'Notifications' => ['base_link' => 'admin/notification', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    'Move_Transactions' => ['base_link' => 'admin/movetransactions', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    'Reprice_Parcels' => ['base' => 'validate', 'base_link' => 'admin/repriceparcels',
                        'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                    'Bulk Shipment Cancellation' => ['base' => 'validate', 'base_link' => 'admin/canceltransactions', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_ADMIN]],
                ],
                'branch' => [ServiceConstant::BRANCH_TYPE_HQ],
            ...
            'Finance' => [
                'base' => 'finance', 'class' => 'fa fa-money', 'base_link' => [
                    'Corporate Shipments' => ['base_link' => 'finance/corporateshipment', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_FINANCE, ServiceConstant::USER_TYPE_BILLING], 'branch' => [ServiceConstant::BRANCH_TYPE_HQ]],
                    ...
                    'Bulk Invoice Tasks' => ['base_link' => 'finance/bulkinvoicetasks', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_FINANCE, ServiceConstant::USER_TYPE_BILLING],
                        'branch' => [ServiceConstant::BRANCH_TYPE_HQ]],
                    'Batching Discount' => ['base_link' => 'parcels/discount', 'class' => ''],
                    'Batching Discount Tasks' => ['base_link' => 'parcels/discount', 'class' => '',
                        'user_type' => [ServiceConstant::USER_TYPE_FINANCE, ServiceConstant::USER_TYPE_BILLING],
                        'branch' => [ServiceConstant::BRANCH_TYPE_HQ]],
                ...
                'user_type' => [ServiceConstant::USER_TYPE_ADMIN, ServiceConstant::USER_TYPE_FINANCE,
                    ServiceConstant::USER_TYPE_BILLING,
