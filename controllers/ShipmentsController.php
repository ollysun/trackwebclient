...
class ShipmentsController extends BaseController
{
    ...
    public function actionReport($page = 1, $page_width = null)
    {
        ...
        $filter_params = ['start_modified_date', 'end_modified_date', 'for_return', 'parcel_type', 'status', 'min_weight', 'max_weight', 'min_amount_due', 'max_amount_due', 'cash_on_delivery', 'delivery_type', 'payment_type', 'shipping_type', 'start_created_date', 'end_created_date', 'created_branch_id', 'from_branch_id', 'route_id', 'request_type'];
