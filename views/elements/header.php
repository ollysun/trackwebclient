        ...
        <div class="clearfix">
            ...
            <div class="nav-no-collapse navbar-left hidden-sm hidden-xs pull-left" id="header-nav-left">
                <ul class="nav navbar-nav pull-left">
                    <li>
                        <a class="btn" id="make-small-nav" data-toggle="tooltip" data-placement="bottom"
            ...
            <?php elseif (!is_null(Calypso::getValue($session_data, 'company.name', null))): ?>
                <div class="nav-no-collapse pull-left navbar-text text-muted text-uppercase">
                    <?= strtoupper(Calypso::getValue($session_data, 'company.name')); ?>
                </div>
            <?php endif; ?>
