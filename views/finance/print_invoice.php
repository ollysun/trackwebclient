...
$numberOfSheets = round((count($invoiceParcels) / $parcelPerSheet));
$remainder = count($invoiceParcels) % $parcelPerSheet;
$numberOfSheets += $remainder > ($parcelPerSheet / 2) && $remainder > 0 ? 0 : 1;
        ...
        <div class="rotate-wrap">
            <div class="rotate">
                ...
                <table class="table table-bordered is-double-bordered">
                    ...
                    <tbody>
                    <?php
                    for ($i = 1; $i <= $parcelPerSheet; $i++):
                        $parcelIndex = ($j * $parcelPerSheet) + ($i - 1);
                        $invoiceParcel = Calypso::getValue($invoiceParcels, "$parcelIndex");
                        ?>
