            ...
            <form action="" class="table-search-form form-inline clearfix">
                <div class="pull-left">
                    ...
                    <div class="input-group input-group-sm input-group-search">
                        <input id="searchInput" type="text" name="search" placeholder="Phone number"
                    ...
                    <table id="table" class="table table-hover">
                        ...
                        foreach ($parcels as $parcel) {
                            ...
                            <tr data-shipment-id="<?= $parcel['id'] ?>">
                                ...
                                <td><a href="<?= Url::toRoute(['/shipments/view?waybill_number=' . \Adapter\Util\Calypso::getValue($parcel, 'waybill_number')]) ?>"
