	...
	<div class="main-box-body">
		<div class="table-responsive">
            ...
            <div class="pull-right form-group">
                <?php if($show_prev): ?>
                    <a href="<?= Url::to(['site/parcelsforsweep?offset='.($offset - $page_width)]) ?>" class="btn btn-primary btn-sm">Prev</a>
                <?php endif;  ?>
                <?php if($show_next): ?>
                    <a href="<?= Url::to(['site/parcelsforsweep?offset='.($offset + $page_width)]) ?>" class="btn btn-primary btn-sm">Next</a>
                <?php endif;  ?>
            </div>
		</div>
	</div>
