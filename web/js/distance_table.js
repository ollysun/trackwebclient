$(document).ready(function () {
    ...
    $("#remove_mapping").unbind("click").on("click", function () {
        var data = $("#update_distance_mapping_form").serialize();
        if (confirm("Are you sure you want to remove this mapping?")) {
            Hub.postToServer("removedistancemapping", data, function (response) {
                window.location.href = 'distancetable';
            });
        }
    });
    $("#update_mapping").unbind("click").on("click", function () {
        ...
        var data = $("#update_distance_mapping_form").serialize();
        Hub.postToServer("updatedistancemapping", data, function (response) {
            window.location.href = 'distancetable';
        });
